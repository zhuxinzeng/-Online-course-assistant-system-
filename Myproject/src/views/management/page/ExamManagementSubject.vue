  ...
  <div class="ES-container">
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        <el-table-column width="80" label="类型" prop="Topictypes"></el-table-column>
        <el-table-column width="80" label="序号" prop="ques_sequence"></el-table-column>
        <el-table-column width="580" label="标题" prop="ques_title"></el-table-column>
        <el-table-column width="500" label="选项" prop="options_list"></el-table-column>
    ...
    <!-- 新增弹出框 -->
    <el-dialog title="新增题目" :visible.sync="addVisible" width="500px">
      <el-form ref="addform" :model="addform" label-width="90px">
        ...
        <el-form-item label="选项A">
          <el-input v-model="addform.options_list_a"></el-input>
        </el-form-item>
         <el-form-item label="选项B">
          <el-input v-model="addform.options_list_b"></el-input>
        </el-form-item>
         <el-form-item label="选项C">
          <el-input v-model="addform.options_list_c"></el-input>
        </el-form-item>
         <el-form-item label="选项D">
          <el-input v-model="addform.options_list_d"></el-input>
        </el-form-item>
