    ...
    >
      ...
      <el-submenu  index="" >
        ...
        <el-menu-item-group>
          ...
          <el-menu-item  @click="goCourseAnnouncement()">课程公告管理</el-menu-item>
        </el-menu-item-group>
      </el-submenu>
      ...
      <el-submenu  index="2" >
        ...
        <el-menu-item-group>
          <el-menu-item @click="goExamManagement()" >发布考试</el-menu-item>
          <el-menu-item  @click="goKnowledgeManagement()">发布知识检测</el-menu-item>
        </el-menu-item-group>
      </el-submenu>
      ...
      <el-menu-item   index="/Adminhome/OnlineQuestion">
       ...
       <el-menu-item >
        ...
        <span slot="title" @click="goDataupload()">资料上传</span>
      </el-menu-item>
       <el-menu-item >
      ...
      <el-menu-item  >
        ...
        <span slot="title" @click="goPersonalInfo()">个人资料设置</span>
      </el-menu-item>
...
export default {
  ...
  methods:{
    ...
    goExamManagement(){
      this.$router.push('/Adminhome/ExamManagement');
    },
    goPersonalInfo(){
       this.$router.push('/Adminhome/PersonalInfo');
    },
    goKnowledgeManagement(){
       this.$router.push('/Adminhome/KnowledgeManagement');
    },
    goCourseAnnouncement(){
       this.$router.push('/Adminhome/CourseAnnouncement');
    },
    goDataupload(){
      this.$router.push('/Adminhome/Dataupload')
    }
  }
};
</script>
