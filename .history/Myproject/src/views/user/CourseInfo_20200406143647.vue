        ...
        <a-tab-pane tab="必修课程" key="1"> 
          <div class="classlist"  >
            <div class="listrow" v-for="(item , index) in coursesallInfo" :key="index">
              <coursesdetailinfo class="listrowspace"  :name="item.TEACHER_NAME" :college="item.TEACHER_COLLEGE" :number='item.COURSE_NUMBER' :coursename="item.COURSE_NAME" :room='item.COURSE_ROOM' :img="item.COURSE_IMAGE" ></coursesdetailinfo>
             </div>
