  ...
  <div class="OE-container">
      ...
      <a-menu v-model="current" mode="horizontal" style="border-radius:10px;box-shadow: 0 0 1px;">
        <a-sub-menu>
          ...
          <a-menu-item-group title="编程基础">
            <a-menu-item key="setting:1">数据结构</a-menu-item>
            <a-menu-item key="setting:2">软件工程</a-menu-item>
          </a-menu-item-group>
          <a-menu-item-group title="编程语言">
            <a-menu-item key="setting:3">C语言教程</a-menu-item>
            <a-menu-item key="setting:4">Java高级编程</a-menu-item>
          </a-menu-item-group>
        </a-sub-menu>
        <a-sub-menu>
          <span slot="title" class="submenu-title-wrapper">
        ...
        <a-sub-menu>
          ...
          <a-menu-item-group title="大学一年级">
            <a-menu-item key="setting:9" @click="showBoxexam()">大学英语（一）</a-menu-item>
    ...
    <div class="examinfo">
      ...
      <section >
       ...
       <p>（3）考生在考场内必须保持安静，不准喧哗，不准交头接耳、左顾右盼、打手势、做暗号、不准夹带、旁窥、抄袭或有意让他人抄袭，不准传抄或交换考试材料。</p>
      </section>
      <div class="startbtn">
        <a-button>开始考试</a-button>
      </div>
    </div>
  </div>
</template>
...
let Boxexam = document.getElementsByClassName('examinfo')
export default {
  name: "",
  props: "",
  components: { Nav },
  ...
  methods: {
   showBoxexam(){
     Boxexam.style.display='flex';
   },
   hideBoxexam(){
     Boxexam.style.display = 'none';
   }
  }
};
</script>
