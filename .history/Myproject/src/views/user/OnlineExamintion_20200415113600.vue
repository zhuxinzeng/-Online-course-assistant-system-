  ...
  <div class="OE-container">
    ...
    <div class="examinfo">
      ...
      <section >
        ...
        <p>(2)考生在考场内必须保持安静，不准喧哗，不准交头接耳、左顾右盼、打手势、做暗号、不准夹带、旁窥、抄袭或有意让他人抄袭，不准传抄或交换考试材料。</p>
        <p>（3）考生在考试过程中如不遵守考场纪律，不服从监考教师管理，有违纪违规行为，按有关规定进行处罚</p>
      </section>
      <div class="startbtn">
...
.OE-container .examinfo section p{
  margin: 10px;
}
