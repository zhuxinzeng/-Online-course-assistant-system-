<template>
  <div class="content">
    ...
    <ul>
      ...
      <li v-for="(item,index) in speak" :key="index" :class="{active:userName == userStorage}">
        <span>
          <font v-if="userName== userStorage">:</font>
          这个是userName：{{userName}} 这个是userStorage:{{userStorage}}
          <font v-if="userName!= userStorage">:</font>
        </span>
        {{item.msg}}
      </li>
