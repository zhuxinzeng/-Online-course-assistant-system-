  ...
  <div class="CI-container">
        ...
        <a-tab-pane tab="必修课程" key="1"> 
          <div class="classlist"  >
            <div class="listrow" v-for="(item , index) in coursesallInfo" :key="index">
              <coursesdetailinfo class="listrowspace"  :teachername="item.TEACHER_NAME"></coursesdetailinfo>
             </div>
    ...
    <div class="footer">
      <div class="pagination">
        <a-pagination  @change="pagechange"   v-model="pageNumber" hideOnSinglePage:true :total="90" ></a-pagination>
      </div>
    </div>
    <!--抽屉-->
