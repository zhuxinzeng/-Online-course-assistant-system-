      ...
      <a-menu v-model="current" mode="horizontal" style="border-radius:10px;box-shadow: 0 0 1px;">
         <a-sub-menu>
          ...
          <a-menu-item-group title="编程语言">
            <a-menu-item key="setting:31">C语言教程</a-menu-item>
            <a-menu-item key="setting:32">Java高级编程</a-menu-item>
          </a-menu-item-group>
        ...
        <a-sub-menu>
          ...
          <a-menu-item-group title="数学基础">
            <a-menu-item key="setting:3">高等数学</a-menu-item>
            <a-menu-item key="setting:4">概率论</a-menu-item>
          </a-menu-item-group>
        </a-sub-menu>
        <a-sub-menu>
          <span slot="title" class="submenu-title-wrapper">
          ...
          <a-menu-item-group title="20世纪">
            <a-menu-item key="setting:5">毛泽东思想</a-menu-item>
            <a-menu-item key="setting:6">马克思主义</a-menu-item>
          </a-menu-item-group>
