<template>
  <div class="TM-container">
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
      ...
      <el-table-column width="280" label="作业题号" prop="Tasksequence"></el-table-column>
      <el-table-column width="280" label="作业题目" prop="Tasktitle"></el-table-column>
    ...
    <el-dialog title="编辑课程" :visible.sync="editVisible" width="500px">
      <el-form ref="form" :model="form" label-width="90px">
        ...
        <el-form-item label="作业题目"  label-width="300px" >
