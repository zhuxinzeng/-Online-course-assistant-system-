      ...
      <div class="upload-info">
        <div>
          <el-upload
            ...
            :file-list="fileList"
          >
            <img v-if="uploadPicUrl" :src="uploadPicUrl" class="uploadavatar" />
            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
          </el-upload>
        </div>
        <div>
          <el-button type="primary" :loading="loading" @click="handleSubmit" class="updatebtn">更新</el-button>
        </div>
      </div>
      <el-form
        :model="ruleForm"
...
.PI-container .upload-info .upload-pic {
 ...
 .PI-container .upload-info .upload-pic .avatar-uploader-icon {
   ...
   .PI-container .upload-info .upload-pic .avatar-uploader .el-upload:hover {
    border-color: #409EFF;
  }
