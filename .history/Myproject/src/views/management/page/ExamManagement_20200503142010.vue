...
export default {
 ...
 //新增考试
    ...
    //新增考试选项
     addoptions(){
       this.newform.examname = this.form.examname;
       this.newform.ques_sequence= this.form.ques_sequence;
       this.newform.ques_title = this.form.ques_title;
           if (this.form.options_list_a) {
            this.newform.options_list.push(this.form.options_list_a)
        }
        if (this.form.options_list_b) {
            this.newform.options_list.push(this.form.options_list_b)
        }
        if (this.form.options_list_c) {
            this.newform.options_list.push(this.form.options_list_c)
        }
        if (this.form.options_list_d) {
            this.newform.options_list.push(this.form.options_list_d)
        }
