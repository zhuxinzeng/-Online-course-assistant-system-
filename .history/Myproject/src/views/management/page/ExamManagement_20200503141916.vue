     ...
     addoptions(){
       ...
       this.newform.ques_title = this.form.ques_title;
           if (this.form.options_list_a) {
            newform.options_list.push(this.form.options_list_a)
        }
        if (this.form.options_list_b) {
            newform.options_list.push(this.form.options_list_b)
        }
        if (this.form.options_list_c) {
            newform.options_list.push(this.form.options_list_c)
        }
        if (this.form.options_list_d) {
            newform.options_list.push(this.form.options_list_d)
        }
