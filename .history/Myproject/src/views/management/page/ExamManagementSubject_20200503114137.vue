  ...
  <div class="ES-container">
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        ...
        <el-table-column width="180" label="题目序号" prop="examtime"></el-table-column>
        <el-table-column width="100" label="题目名称" prop="examscore"></el-table-column>
        <el-table-column width="200" label="题目选项" prop="ques_number"></el-table-column>
