<template>
  <div class="TM-container">
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
      ...
      <el-table-column width="180" label="名称" prop="Taskname"></el-table-column>
      <el-table-column width="180" label="题号" prop="Tasksequence"></el-table-column>
      <el-table-column width="180" label="题目" prop="Tasktitle"></el-table-column>
      <el-table-column width="180" label="答案" prop="Taskanswer"></el-table-column>
