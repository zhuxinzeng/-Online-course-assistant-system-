    ...
    <el-dialog title="编辑" :visible.sync="rateVisible" width="30%">
      <el-form ref="form" :model="form" label-width="70px">
        ...
        <el-form-item label="优秀">
          <el-input-number v-model="form.medal" :step="5"></el-input-number>
        </el-form-item>
         <el-form-item label="良好">
          <el-input-number v-model="form.medal" :step="3"></el-input-number>
        </el-form-item>
         <el-form-item label="合格">
          <el-input-number v-model="form.medal" :step="1"></el-input-number>
        </el-form-item>
      </el-form>
