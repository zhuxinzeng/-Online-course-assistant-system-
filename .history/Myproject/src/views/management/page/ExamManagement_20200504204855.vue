  ...
  <div class="EM-container">
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        <el-table-column width="80" label="考试名称" prop="ques_sequence"></el-table-column>
        <el-table-column width="80" label="考试名称" prop="examname"></el-table-column>
        <el-table-column width="180" label="考试时间" prop="examtime" v-show='showexam'></el-table-column>
        <el-table-column width="100" label="考试分数" prop="examscore" v-show='showexam'></el-table-column>
        <el-table-column width="200" label="题目数量" prop="ques_number" v-show='showexam'></el-table-column>
