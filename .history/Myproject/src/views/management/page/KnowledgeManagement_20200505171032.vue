    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        <el-table-column width="80" label="编号" prop="Checksequence"></el-table-column>
         <el-table-column width="210" label="课程ID" prop="_id"></el-table-column>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button size="mini" @click="checkeknowledegoptions()">查看题目</el-button>
    ...
    <el-dialog title="添加选项" :visible.sync="optionsVisible" width="500px">
      <el-form ref="form" :model="form" label-width="90px">
        ...
        <el-form-item label="标题">
          <el-input type="textarea" v-model="form.Testtitle"></el-input>
        </el-form-item>
        <el-form-item label="选项A">
          <el-input v-model="form.options_list"></el-input>
        </el-form-item>
        ...
        <el-form-item label="选项D">
          ...
          <el-input v-model="form.correctanswers"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    addoptions() {
      axios({
        url: url.addeknowledegoptionsinfo,
        method: "post",
        data: {
          knowledegoptions: this.form
        }
      }).then(response => {
        console.log(response);
        if (response.data.code == 200) {
    ...
    //查看已添加知识检测选项
    checkeknowledegoptions() {
      axios({
        url: url.geteknowledegoptionsinfo,
        method: "post",
        data: {}
      }).then(response => {
        console.log(response);
