     ...
     <h2>注册信息填写</h2>
      ...
      <el-form-item label="真实姓名" prop="name" size="small"  >
        ...
        <el-form-item label="电子邮箱" prop="email" size="small">
          <el-input  v-model="ruleForm.email" autocomplete="off"  type="text"  prefix-icon='el-icon-user-solid'></el-input>
        </el-form-item>
         <el-form-item label="常用电话" prop="tel" size="small">
          <el-input   v-model="ruleForm.tel" autocomplete="off"  type="text"  prefix-icon='el-icon-user-solid'></el-input>
        </el-form-item>
         <el-form-item label="所属学院" prop="college" size="small">
          <el-input   v-model="ruleForm.college" autocomplete="off"  type="text"  prefix-icon='el-icon-user-solid'></el-input>
        </el-form-item>
         <el-form-item label="所属职务" prop="job" size="small">
          <el-input   v-model="ruleForm.job" autocomplete="off"  type="text"  prefix-icon='el-icon-user-solid'></el-input>
        </el-form-item>
