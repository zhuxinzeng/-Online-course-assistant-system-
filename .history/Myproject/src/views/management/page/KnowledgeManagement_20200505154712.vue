  ...
  <div class="KM-container">
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        ...
        <el-table-column width="80" label="名称" prop="examname"></el-table-column>
        <el-table-column width="180" label="分数" prop="examtime"></el-table-column>
    ...
    <el-dialog title="新增考试" :visible.sync="addVisible" width="500px">
      <el-form ref="addform" :model="addform" label-width="90px">
        ...
        <el-form-item label="题目数量">
          <el-input v-model="addform.Checknimber"></el-input>
        </el-form-item>
