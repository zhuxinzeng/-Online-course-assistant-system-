  ...
  <div class="ES-container">
    ...
    <div class="table">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        <el-table-column width="80" label="类型" prop="examname"></el-table-column>
        <el-table-column width="80" label="序号" prop="examtime"></el-table-column>
        <el-table-column width="580" label="标题" prop="examscore"></el-table-column>
        <el-table-column width="500" label="选项" prop="ques_number"></el-table-column>
