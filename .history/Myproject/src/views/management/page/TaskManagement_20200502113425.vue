<template>
  <div class="TM-container">
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
      ...
      <el-table-column width="180" label="名称" prop="studentid"></el-table-column>
      <el-table-column width="180" label="题号" prop="name"></el-table-column>
      <el-table-column width="180" label="题目" prop="major"></el-table-column>
      <el-table-column width="180" label="答案" prop="result"></el-table-column>
