<template>
  <div class="EM-container">
      ...
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button size="mini" @click="addOptions(scope.$index, scope.row)">添加题目</el-button>
    ...
    <!-- 选项添加弹出框 -->
    <el-dialog title="添加选项" :visible.sync="editVisible" width="500px">
      <el-form ref="form" :model="form" label-width="90px">
...
export default {
 ...
 //新增考试
    ...
    goExamSubject(){
      this.$router.push("/ExamManagementSubject");
    },
    goback() {
