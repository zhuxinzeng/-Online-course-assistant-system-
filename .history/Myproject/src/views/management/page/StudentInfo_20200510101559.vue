<template>
  <div class="SI-container">
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" border>
      ...
      <el-table-column width="180" label="是否已评价" prop="evaluate"></el-table-column>
    ...
    <el-dialog title="编辑" :visible.sync="rateVisible" width="30%">
      <el-form ref="form" :model="form" label-width="70px" size="mini">
        ...
        <el-form-item label="总评分" disabled>
          <el-input v-model="form.medal"></el-input>
        </el-form-item>
        <el-rate v-model="rate" @change="handRatechange()" show-score text-color="#ff9900"></el-rate>
        <!-- <el-form-item label="优秀">
          <el-input-number v-model="form.medal" size="mini" :step="5"></el-input-number>
        </el-form-item>
         <el-form-item label="良好">
          <el-input-number v-model="form.medal" size="mini" :step="3"></el-input-number>
        </el-form-item>
         <el-form-item label="合格">
          <el-input-number v-model="form.medal" size="mini" :step="1"></el-input-number>
        </el-form-item>-->
      </el-form>
  ...
  methods: {
    ...
    updateRate() {
      axios({
        ...
        data: {
          _id: this.form._id,
          medal: this.form.medal + this.rate,
