  ...
  <div class="EM-container">
    ...
    >
      ...
      >
        ...
        题目选项1
       <el-input v-model="exam.options_list[0]"></el-input>
        题目选项2
       <el-input v-model="exam.options_list[1]"></el-input>
        题目选项3
       <el-input v-model="exam.options_list[2]"></el-input>
        题目选项4
       <el-input v-model="exam.options_list[3]"></el-input>
