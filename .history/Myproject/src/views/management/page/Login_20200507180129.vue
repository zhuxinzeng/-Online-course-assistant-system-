        ...
        <el-form ref="form" :model="form" label-width="40px">
          ...
          <el-form-item>
            <div class="input">
              ...
              <input v-model="form.pass" show-password>
            </div>
          </el-form-item>
          <el-form-item class="btn">
            <button type="primary" @click="login()"> <span>登录</span> </button>
            <button @click="jumpregister()"><span>注册</span></button>
          </el-form-item>
        </el-form>
      </div>
    </div>
...
.login-content .info .btn button span{
margin-top: -10px;
}
