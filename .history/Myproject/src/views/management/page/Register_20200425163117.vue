    ...
    <div class="content">
     <h2>注册信息填写</h2>
      ...
      <el-form-item label="真实姓名" prop="name" size="small"  >
          <el-input  v-model="ruleForm.name" autocomplete="off"  type="text"  prefix-icon='el-icon-user'></el-input>
        </el-form-item>
        <el-form-item label="账号密码" prop="pass" size="small"  >
          <el-input type="text" v-model="ruleForm.pass" autocomplete="off" prefix-icon='el-icon-view' ></el-input>
        </el-form-item>
         <el-form-item label="确认密码" prop="checkPass" size="small" >
          <el-input  v-model="ruleForm.checkPass" autocomplete="off" type="text" prefix-icon='el-icon-view'></el-input>
        </el-form-item>
        <el-form-item label="电子邮箱" prop="email" size="small">
          <el-input  v-model="ruleForm.email" autocomplete="off"  type="text"  prefix-icon='el-icon-mobile'></el-input>
        </el-form-item>
         <el-form-item label="常用电话" prop="tel" size="small">
          <el-input   v-model="ruleForm.tel" autocomplete="off"  type="text"  prefix-icon='el-icon-phone-outline'></el-input>
        </el-form-item>
         <el-form-item label="所属学院" prop="college" size="small">
          <el-input   v-model="ruleForm.college" autocomplete="off"  type="text"  prefix-icon='el-icon-house'></el-input>
        </el-form-item>
