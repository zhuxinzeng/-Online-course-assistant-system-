<template>
  <div class="PI-container">
    <div class="nav">
      ...
      <div class="btn">
        <el-button @click="showform()">编辑信息</el-button>
      </div>
      </div>
    </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      domain: "https://upload-z2.qiniup.com", // 七牛云的上传地址（华东区）
      qiniuaddr: "qb8905coh.bkt.clouddn.com", // 七牛云的图片外链地址
      imageurl: "", //提交到后台图片地址
      uploadPicUrl: "",
      avatar_img: ""
    };
