    ...
    //新增考试选项
     addoptions(){
       ...
       this.newform.ques_title = this.form.ques_title;
           if (form.options_list_a) {
            newform.options_list.push(form.options_list_a)
        }
        if (form.options_list_b) {
            newform.options_list.push(form.options_list_b)
        }
        if (form.options_list_c) {
            newform.options_list.push(form.options_list_c)
        }
        if (form.options_list_d) {
            newform.options_list.push(form.options_list_d)
        }
