    ...
    <div class="header-right">
      <div class="header-user-con">
        ...
        <div class="user-avator">
          <el-avatar :src='avatar' shape="square" fit="scale-down" style="width:45px;height:45px" ></el-avatar>
        </div>
        <!-- 用户名下拉菜单 -->
    ...
    getavatar() {
      axios({
        ...
        if (response.data.code == 200) {
          ...
          this.$store.commit("saveavatarurl",avatarurl)
          sessionStorage.setItem("saveavatarurl",avatarurl)
