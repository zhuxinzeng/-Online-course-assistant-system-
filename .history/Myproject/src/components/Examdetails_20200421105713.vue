<template>
  <div class="EXD-container">
    ...
    <div class="middle-content">
      ...
      <div class="EXD-content" v-for="(item,index) in examMultiple"
        :key="index+2"
         >
        ({{item.Topictypes}})
        {{item.ques_sequence}}
   ...
   <div class="Submitpaper">
    <a-button class=".EXD-btn"  @click="showModal" :disabled="Showsubmit">交卷</a-button>
    <a-modal title="" v-model="showmodel" @ok="hideModal" okText="确认" cancelText="取消">
      <p style="font-size:20px">是否交卷？</p>
    </a-modal>
    <br />
    <br />
  </div>
