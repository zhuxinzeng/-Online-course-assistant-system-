<template>
  <div class="Login">
    ...
    <a-button class="Mbtn" @click="adminlogin()">管理登录</a-button>
    <div class="L-form">
      <P>用户登录</P>
      ...
      axios({
        ...
        .then(response => {
          ...
          if (response.data.code == 200 && response.data.message) {
            this.userid = response.data.userinfo._id;
            this.studentid = response.data.userinfo.studentid;
            this.major = response.data.userinfo.major;
