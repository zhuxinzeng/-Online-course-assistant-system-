    ...
    <div class="R-form">
      ...
      <a-form :form="form" :layout="formLayout" @submit="handleSubmit" class="Form">
        <a-form-item
          ...
          :aria-errormessage="studentidErrorMsg"
        >
        ...
        <a-form-item
          ...
          :label-col="formItemLayout.labelCol"
          :wrapper-col="formItemLayout.wrapperCol"
          :aria-errormessage="emailErrorMsg"
        >
          <a-input v-model="eamil" name="email">
            <a-icon slot="prefix" type="user" />
          </a-input>
        </a-form-item>
        <a-form-item
          ...
          :label-col="formItemLayout.labelCol"
          :wrapper-col="formItemLayout.wrapperCol"
          :aria-errormessage="telErrorMsg"
        >
          <a-input v-model="tel" name="tel">
            <a-icon slot="prefix" type="user" />
          </a-input>
        </a-form-item>
        <a-form-item
          ...
          :label-col="formItemLayout.labelCol"
          :wrapper-col="formItemLayout.wrapperCol"
          :aria-errormessage="majorErrorMsg"
        >
      ...
      axios({
        ...
        .then(response => {
          ...
          if (response.status == 200) {
            let userid = response.data.message;
