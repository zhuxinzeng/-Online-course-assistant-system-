<template>
  <div class="nav">
    ...
    <div class="info">
      ...
      <p>{{userInfo}}</p>
      <a-menu slot="overlay" @click="handleMenuClick"  style="width:100px">
        <a-menu-item key="1"> <a-icon  />1st menu item </a-menu-item>
        <a-menu-item key="2"> <a-icon  />2nd menu item </a-menu-item>
      </a-menu>
