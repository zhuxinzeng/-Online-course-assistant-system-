      ...
      <div class="EXD-content" v-for="(item,index) in examMultiple" :key="index+2">
        ...
        <div class="content-option">
          <a-checkbox-group @change="Change">
            <a-row>
              <a-col :span="10" class="optionspace">
                <a-checkbox value="A" :disabled="Disable">A.{{item.options_list[0].options_title}}</a-checkbox>
              </a-col>
              <a-col :span="10" class="optionspace">
                <a-checkbox value="B" :disabled="Disable">B.{{item.options_list[1].options_title}}</a-checkbox>
              </a-col>
              <a-col :span="10" class="optionspace">
                <a-checkbox value="C" :disabled="Disable">C.{{item.options_list[2].options_title}}</a-checkbox>
              </a-col>
              <a-col :span="10" class="optionspace">
                <a-checkbox value="D" :disabled="Disable">D.{{item.options_list[3].options_title}}</a-checkbox>
              </a-col>
            </a-row>
          </a-checkbox-group>
        </div>
