<template>
  <div class="nav">
    ...
    <div class="info">
      ...
      <p>{{userInfo}}</p>
      <a-menu slot="overlay" @click="handleMenuClick" style="width:75px;height:30px;font-size:5px;margin-top:-3px"  class="loginout">
        <a-menu-item key="1" > <p> 退出登录</p> </a-menu-item>
      </a-menu>
    </a-dropdown>
    </div>
    </div>
