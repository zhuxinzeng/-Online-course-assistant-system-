<template>
  <div class="nav">
    ...
    <div class="info">
      ...
      <p>{{userInfo}}</p>
      <a-menu slot="overlay" @click="handleMenuClick" style="width:75px;font-size:5px;"  class="loginout">
        <a-menu-item key="1" > <p style="margin-top:-5px;height:30px"> 退出登录</p> </a-menu-item>
