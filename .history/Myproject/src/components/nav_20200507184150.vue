<template>
  <div class="nav">
    ...
    <div class="info">
      ...
      <div class="dropdown" style="width:75px;height:30px;font-size:5px;" >
       <a-dropdown @click="handleButtonClick" placement="bottomLeft " style="width:75px;height:30px;font-size:5px;" >
      <p>{{userInfo}}</p>
      <a-menu slot="overlay" @click="handleMenuClick" style="width:75px;height:30px;font-size:5px;"  class="loginout">
        <a-menu-item key="1" > <p style="margin-top:-5px"> 退出登录</p> </a-menu-item>
         <a-menu-item key="1" > <p style="margin-top:-5px"> 退出登录</p> </a-menu-item>
      </a-menu>
