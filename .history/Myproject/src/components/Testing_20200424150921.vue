        ...
        <a-row>
          <a-radio-group>
            <a-col :span="10" class="optionspace">
              <a-radio value="A" @change="onChange">A.{{item.options_list}}</a-radio>
            </a-col>
            <a-col :span="10" class="optionspace">
              <a-radio value="B" @change="onChange">B.{{item.options_list}}</a-radio>
            </a-col>
            <a-col :span="10" class="optionspace">
              <a-radio value="C" @change="onChange">C.{{item.options_list}}</a-radio>
            </a-col>
            <a-col :span="10" class="optionspace">
              <a-radio value="D" @change="onChange">D.{{item.options_list}}</a-radio>
            </a-col>
          </a-radio-group>
        </a-row>
      </div>
