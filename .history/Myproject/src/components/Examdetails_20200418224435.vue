  ...
  <div class="EXD-container">
    ...
    <div class="middle-content">
      ...
      <div class="EXD-content" v-for="(item,index) in examinfo" :key="index">
        ...
        <div class="content-option">
          <a-row>
            <a-col :span="12" class="optionspace">
              <a-checkbox value="A" @change="onChange" :disabled='Disable'>A.{{item.options_list[0].options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox value="B" @change="onChange" :disabled='Disable'>B.{{item.options_list[1].options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox value="C" @change="onChange" :disabled='Disable'>C.{{item.options_list[2].options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox value="D" @change="onChange" :disabled='Disable'>D.{{item.options_list[3].options_title}}</a-checkbox>
            </a-col>
        ...
        <div>
          <a-button @click="callback()" class="EXD-btn" id="sure">
            <p>
              <b>确定</b>
            </p>
          </a-button>
...
export default {
  ...
  methods: {
    ...
    callback(btn) {
      var btn = document.getElementsByClassName("ant-checkbox-input");
      btn.disabled = true;
      console.log(btn )
    },
