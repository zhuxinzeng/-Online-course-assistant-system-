<template>
  <div class="EXD-container">
    ...
    <div class="middle-content">
      <div :display='showSingleinfo' class="EXD-content" v-for="(item,index) in examSingleinfo" :key="index">
        ({{item.Topictypes}})
        {{item.ques_sequence}}
        {{item.ques_title}}
        <!-- {{item.options_list}} -->
      ...
      <div v-show="false" class="EXD-content" v-for="(item,index) in examJudge" :key="index">
        ({{item.Topictypes}})
        {{item.ques_sequence}}
        {{item.ques_title}}
        <!-- {{item.options_list}} -->
