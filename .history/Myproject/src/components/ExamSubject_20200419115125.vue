        ...
        <div class="content-option">
          <a-row>
            <a-col :span="12" class="optionspace">
              ...
              >A.{{options_list.options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox
                value="B"
              ...
              >B.{{options_list.options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox
                value="C"
              ...
              >C.{{options_list.options_title}}</a-checkbox>
            </a-col>
            <a-col :span="12" class="optionspace">
              <a-checkbox
                value="D"
              ...
              >D.{{options_list.options_title}}</a-checkbox>
            </a-col>
