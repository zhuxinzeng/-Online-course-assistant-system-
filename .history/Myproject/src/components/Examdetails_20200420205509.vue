<template>
  <div class="EXD-container">
    ...
    <div class="middle-content">
      <div v-show="showSingleinfo" class="EXD-content" v-for="(item,index) in examSingleinfo"
        :key="index"
        >
        ({{item.Topictypes}})
        {{item.ques_sequence}}
      ...
      <div class="EXD-content" v-for="(item,index) in examMultiple" :key="index">
        ({{item.Topictypes}})
        {{item.ques_sequence}}
        {{item.ques_title}}
        <!-- {{item.options_list}} -->
              ...
              <a-col :span="10" class="optionspace">
               ...
               <a-col :span="10" class="optionspace">
                <a-checkbox
                  ...
                  @change="onChange"
                  :disabled="Disable"
                >A.{{item.options_list[2].options_title}}</a-checkbox>
              </a-col>
               <a-col :span="10" class="optionspace">
                <a-checkbox
                  s
                  ...
                  @change="onChange"
                  :disabled="Disable"
                >A.{{item.options_list[3].options_title}}</a-checkbox>
              </a-col>
            </a-checkbox-group>
