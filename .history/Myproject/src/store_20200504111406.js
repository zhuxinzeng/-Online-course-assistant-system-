...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    saveAdminuserid(state, adminuser_id) {
      state.adminusername = adminuser_id;
      sessionStorage.setItem("adminusername", adminuser_id)
      console.log('Vuex端存储' + adminuser_id);
      console.log('sessionStorage存储' + sessionStorage.getItem("adminuser_id"));
      localStorage.setItem("adminusername", JSON.stringify(adminuser_id));
    }
