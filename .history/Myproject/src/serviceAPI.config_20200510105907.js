...
const URL = {
  ...
  senduserimgurl:LOCALURL+'user/sendimgurl',    //向数据库发送图片的url
  getuseravatarurl:LOCALURL+'user/getavatarurl', //得到头像图片链接
  ...
  getuploaddata:LOCALURL+'Dataupload/getuploaddata', //得到资料下载的数据
  getrate:LOCALURL+"result/getrate",              // 得到徽章数据


  //管理端
  adminregister: LOCALURL + 'adminuser/register', //管理端注册
  adminlogin: LOCALURL + 'adminuser/login', //管理端登录
  getimgurl:LOCALURL+'adminuser/getimgurl',    //向数据库发送图片的url
  getavatarurl:LOCALURL+'adminuser/getavatarurl', //得到头像图片链接
  ...
  senduploaddata:LOCALURL+'Dataupload/senduploaddata',   //发送上传资料信息
  ...
  updateRate:LOCALURL+"result/updateRate",             //更新学生徽章
