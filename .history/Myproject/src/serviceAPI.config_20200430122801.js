...
const URL = {
  ...
  getcoursesinfo:LOCALURL+'coursesmanage/getcoursesinfo', 
  changecoursesinfo:LOCALURL+"coursesmanage/changecoursesinfo" ,    //获取全部课程信息
  addcourseinfo:LOCALURL+'coursesmanage/addcourseinfo',  //新增课程
  deletecoursesinfo:LOCALURL+'coursesmanage/deletecoursesinfo', //删除课程
  getstudentinfo:LOCALURL+'coursesmanage/getadminuserinfo',    //获取全部的课程信息
