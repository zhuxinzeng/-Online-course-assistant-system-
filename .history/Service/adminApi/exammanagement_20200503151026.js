...
router.post('/addexamoptionsinfo', async (ctx) => {
    try {
        ...
        newexaminfo.push({examname:examinfo.examname})
        newexaminfo.push({ques_sequence:examinfo.ques_sequence})
        newexaminfo.push({ques_title:examinfo.ques_title})
        newexaminfo.push({options_list:options_list})
